...
namespace XYO\Library {
    ...
    class OverlayScrollbars extends \XYO\Web\Component
    {
        ...
        {
            $this->view->cssLinks->set(self::$name, $this->site . "site/library/overlayscrollbars.min.css");
            $this->view->jsLinks->set(self::$name, $this->site . "site/library/overlayscrollbars.browser.es6.min.js", "defer");
            $this->view->jsLinks->set(self::$name, $this->site . "site/library/overlayscrollbars.js", "defer");
