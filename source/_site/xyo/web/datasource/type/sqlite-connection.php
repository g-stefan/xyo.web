...
namespace XYO\Web\DataSource\Type\SQLite {
    ...
    require_once("./_site/xyo/web/datasource/type/sqlite-table.php");
    require_once("./_site/xyo/web/datasource/type/sqlite-query.php");
    ...
    class Connection
    {
        ...
        {
            $table = new \XYO\Web\DataSource\Type\SQLite\Table($this, $connector);
            return $table;
        }

        public function &connectQuery(&$connector = null)
        {
            $query = new \XYO\Web\DataSource\Type\SQLite\Query($this, $connector);
            return $query;
        }
