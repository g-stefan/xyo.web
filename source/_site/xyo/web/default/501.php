...
class HTTP501 extends \XYO\Web\Page
{
    public function init($options = null)
    {
        http_response_code(501);

        $this->setTitle("501 Not Implemented");
                ...
                <div class="mx-auto max-w-md">
                    ...
                    <div class="min-w-96 divide-y divide-gray-300/50">
                        <div class="space-y-6 py-8 text-center text-base leading-7 text-gray-600">
                            <p class="text-9xl">501</p>
                            <p class="text-2xl">Not Implemented</p>
                        </div>
                        <div class="pt-8 text-center text-base font-semibold leading-7">
                            <p class="text-gray-900">The server does not support the functionality required to fulfill the
                                request</p>
                        </div>
                    </div>
                </div>
