...
class PostgreSQLConnection extends \XYO\Web\DataSource\AbstractSQLConnection
{
    protected $user;
    protected $password;
    protected $server;
    ...
    {
        return new PostgreSQLTable($this, $connector);
    }

    protected function newQuery($connector)
    {
        return new PostgreSQLQuery($this, $connector);
    }
}
