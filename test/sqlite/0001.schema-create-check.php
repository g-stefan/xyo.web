...
// SQLite storage lifecycle: createStorage / storageCheckTable /
// destroyStorage / recreateStorage, plus the INTEGER PRIMARY KEY ASC
// AUTOINCREMENT form.
...
t_section("AUTOINCREMENT / INTEGER PRIMARY KEY behaves");
$user->empty();
$user->name = "Ada";
